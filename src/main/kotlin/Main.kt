...
fun main() {
    ...
    val car = Vehicle("AAA", VehicleType.AUTO, Calendar.getInstance(), "CARD_009")
    ...
    val car1 = Vehicle("AAE", VehicleType.AUTO, Calendar.getInstance(), "CARD_003")
    ...
    val bus5 = Vehicle("ATC", VehicleType.BUS, Calendar.getInstance(), "CARD_019")
